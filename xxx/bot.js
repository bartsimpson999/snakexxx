function determineBotMove(game) {
  ...
  if (!playerHasMoved) {
    return null; // o qualsiasi valore che indica che il bot non si muove
  }
...
// Funzione chiamata ogni volta che il giocatore fa una mossa
function playerMove(direction) {
  // ... (codice per muovere il giocatore)

  // Imposta playerHasMoved a true dopo la prima mossa del giocatore
  playerHasMoved = true;
}
